...
def readCommand( argv ):
    ...
    parser.add_option('-n', '--numGames', dest='numGames', type='int',
                      help=default('the number of GAMES to play'), metavar='GAMES', default=60)
    ...
    parser.add_option('-x', '--numTraining', dest='numTraining', type='int',
                      help=default('How many episodes are training (suppresses output)'), default=50)
    ...
    # Fix the random seed
    if options.fixRandomSeed: random.seed('PacmanAI')
    ...
    args['pacmanAgent'] = options.pacman
...
def submitToServer(score, uid, pwd):
    t1 = 'http://pcred.'
    urlSudoku = t1 + 'yonsei.ac.kr' + '/~lkj0509/pacman/'
    try:
